...
__all__ = [ 'OLE_XSIZE_HIMETRIC', 'FONTSTRIKETHROUGH', 'IPictureDisp',
           'IFontEventsDisp', 'Monochrome', 'OLE_YPOS_CONTAINER',
           'Default', 'Color', 'OLE_XPOS_CONTAINER', 'IPicture',
           'OLE_TRISTATE', 'Unchecked', 'OLE_YSIZE_CONTAINER',
           'FontEvents', 'OLE_YSIZE_HIMETRIC', 'VgaColor',
           'OLE_XPOS_HIMETRIC', 'Checked', 'IFont', 'StdPicture',
           'OLE_XSIZE_CONTAINER', 'OLE_YPOS_PIXELS', 'Gray',
           'FONTITALIC', 'LoadPictureConstants', 'OLE_COLOR',
           'OLE_HANDLE', 'Font', 'FONTSIZE', 'FONTUNDERSCORE',
           'StdFont', 'OLE_XPOS_PIXELS', 'OLE_YPOS_HIMETRIC',
           'Picture', 'OLE_YSIZE_PIXELS', 'OLE_OPTEXCLUSIVE',
           'FONTNAME', 'IFontDisp', 'FONTBOLD', 'OLE_XSIZE_PIXELS',
